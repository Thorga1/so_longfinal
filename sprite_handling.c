...
/*   Updated: 2025/01/18 17:56:05 by thorgal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_images(t_data *data)
{
    ...
    data->img_collectible = load_image(data, "textures/collectable.xpm");
...
static void draw_tile(t_data *data, char tile, int x, int y)
{
    if (tile == '1')
        ...
        mlx_put_image_to_window(data->mlx, data->win, data->img_collectible, x, y);
    else if (tile == 'P')
